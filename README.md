...
自行编辑`main/network_config.h`填写本机Wi-Fi与服务器地址后运行`platformio run`。配置模板不含真实凭据；编译不等于烧录。本轮分段延迟说明在`docs/项目指南/voice_latency_logging.md`。
